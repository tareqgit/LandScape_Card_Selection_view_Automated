...
public class EnhanceItem : MonoBehaviour
{
    ...
    //this method calls from EnhanceScrollView, not from the extended class.
    public void UpdateScrollViewItems(
        ...
        float scaleValue)
    {
        Vector3 targetPos = Vector3.one;//setting targetPos={1,1,1}
        Vector3 targetScale = Vector3.one;//setting targetScale={1,1,1}
        // position
        targetPos.x = xValue;
        targetPos.y = yValue;
    ...
    //This method created for using from extended Class and works for onclick button Actions
    protected virtual void OnClickEnhanceItem()
    {
        EnhanceScrollView.GetInstance.SetHorizontalTargetItemIndex(this);
    }

    //This method created for using from extended Class
    ...
    //This method created for using from extended Class AND EnhanceScrollView
